...
//
//    @Test
//    public void usersAreRemovedCorrectly() throws DatabaseSideException, UserNotFoundException {
//        UserManagementService ums = new UserManagementServiceImpl(dc);
...
//
//    @Test
//    public void userPropertiesChangedCorrectly() throws DatabaseSideException, UserNotFoundException {
//        UserManagementService ums = new UserManagementServiceImpl(dc);
//        ums.registerNewUser(UserDto.builder().firstName("John").secondName("Doe").build());
...
//
//    @Test
//    public void removedUserscatsAreRemovedCorrectly() throws DatabaseSideException, UserNotFoundException {
//        UserManagementService ums = new UserManagementServiceImpl(dc);
//        ums.registerNewUser(UserDto.builder().firstName("John").secondName("Doe").build());
//        ums.registerNewUser(UserDto.builder().firstName("John").secondName("Doe").build());
//
